...
const ImageUpload = ({ onUpload }) => {
  ...
  const makeAspectCrop = (defaultCropParams, imageWidth, imageHeight) => {
    const newCropParams = { ...defaultCropParams };
    if (defaultCropParams.width + defaultCropParams.x > imageWidth) {
      newCropParams.width = imageWidth;
    }
    if (defaultCropParams.height + defaultCropParams.y > imageHeight) {
      newCropParams.height = imageHeight;
    }
